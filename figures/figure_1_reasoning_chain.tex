...
% Self-contained standalone source that reproduces Figure 1 of the manuscript
% directly from LaTeX/TikZ (no manuscript sources or private data required).
%
% Build (either works; produces a tightly cropped figure_1_reasoning_chain.pdf):
...
%   clinical context. Steps 2-6 assess five domains independently (parallel).
%   Step 7 integrates findings across domains, identifying co-occurring
%   patterns. Step 8 produces the prognostic summary.
% ============================================================================
...
% Colour-blind-safe palette (identical RGB values to the manuscript).
...
% In the manuscript \revblue{} highlights revised text; in this final,
% standalone figure it is the identity (no revision markup).
\newcommand{\revblue}[1]{#1}
...
\node[progbox, below=0.7cm of s7] (s8) {\textbf{Step 8:} Prognostic\\\revblue{summary}};
